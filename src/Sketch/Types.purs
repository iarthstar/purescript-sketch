...
instance encodeTextLayer :: Encode TextLayer where encode = genericEncode (defaultOptions { unwrapSingleConstructors = true })
instance decodeTextLayer :: Decode TextLayer where decode = genericDecode (defaultOptions { unwrapSingleConstructors = true })


newtype TextStyle = TextStyle
  { type              :: String
  , id                :: String
  , opacity           :: Number
  , alignment         :: String
...
instance encodeTextStyle :: Encode TextStyle where encode = genericEncode (defaultOptions { unwrapSingleConstructors = true })
instance decodeTextStyle :: Decode TextStyle where decode = genericDecode (defaultOptions { unwrapSingleConstructors = true })


newtype GroupLayer = GroupLayer
  { type   :: String
  , id     :: String
  , frame  :: Frame
  , name   :: String
...
instance encodeGroupStyle :: Encode GroupStyle where encode = genericEncode (defaultOptions { unwrapSingleConstructors = true })
instance decodeGroupStyle :: Decode GroupStyle where decode = genericDecode (defaultOptions { unwrapSingleConstructors = true })
...
instance encodeImageLayer :: Encode ImageLayer where encode = genericEncode (defaultOptions { unwrapSingleConstructors = true })
instance decodeImageLayer :: Decode ImageLayer where decode = genericDecode (defaultOptions { unwrapSingleConstructors = true })


newtype ImageStyle = ImageStyle
  { type    :: String
  , id      :: String
  , opacity :: Number
  , shadows :: Maybe (Array Shadow)
...
instance encodeImageStyle :: Encode ImageStyle where encode = genericEncode (defaultOptions { unwrapSingleConstructors = true })
instance decodeImageStyle :: Decode ImageStyle where decode = genericDecode (defaultOptions { unwrapSingleConstructors = true })
...
instance encodeImageData :: Encode ImageData where encode = genericEncode (defaultOptions { unwrapSingleConstructors = true })
instance decodeImageData :: Decode ImageData where decode = genericDecode (defaultOptions { unwrapSingleConstructors = true })
...
instance encodeShapeLayer :: Encode ShapeLayer where encode = genericEncode (defaultOptions { unwrapSingleConstructors = true })
instance decodeShapeLayer :: Decode ShapeLayer where decode = genericDecode (defaultOptions { unwrapSingleConstructors = true })


newtype ShapeStyle = ShapeStyle
  { type    :: String
  , id      :: String
  , opacity :: Number
...
instance encodeShapeStyle :: Encode ShapeStyle where encode = genericEncode (defaultOptions { unwrapSingleConstructors = true })
instance decodeShapeStyle :: Decode ShapeStyle where decode = genericDecode (defaultOptions { unwrapSingleConstructors = true })
...
instance encodeFill :: Encode Fill where encode = genericEncode (defaultOptions { unwrapSingleConstructors = true })
instance decodeFill :: Decode Fill where decode = genericDecode (defaultOptions { unwrapSingleConstructors = true })
...
instance encodeBorder :: Encode Border where encode = genericEncode (defaultOptions { unwrapSingleConstructors = true })
instance decodeBorder :: Decode Border where decode = genericDecode (defaultOptions { unwrapSingleConstructors = true })
...
instance encodePoints :: Encode Points where encode = genericEncode (defaultOptions { unwrapSingleConstructors = true })
instance decodePoints :: Decode Points where decode = genericDecode (defaultOptions { unwrapSingleConstructors = true })
...
instance encodeShadow :: Encode Shadow where encode = genericEncode (defaultOptions { unwrapSingleConstructors = true })
instance decodeShadow :: Decode Shadow where decode = genericDecode (defaultOptions { unwrapSingleConstructors = true })
...
instance encodeGradient :: Encode Gradient where encode = genericEncode (defaultOptions { unwrapSingleConstructors = true })
instance decodeGradient :: Decode Gradient where decode = genericDecode (defaultOptions { unwrapSingleConstructors = true })
...
instance encodeStop :: Encode Stop where encode = genericEncode (defaultOptions { unwrapSingleConstructors = true })
instance decodeStop :: Decode Stop where decode = genericDecode (defaultOptions { unwrapSingleConstructors = true })
